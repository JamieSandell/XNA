...
namespace Lesson_07
{
    public class Pyramid
    {
        ...
        private void InitialiseVertices()
        {
            ...
            VertexPositionNormalTextureColor[] triangleVerticesFront = new VertexPositionNormalTextureColor[3];
            ...
            triangleVerticesFront[0].Color = Color.White;
            ...
            triangleVerticesFront[1].Color = Color.White;
            ...
            triangleVerticesFront[2].Color = Color.White;
            triangleVerticesFront[2].TextureCoordinate = bottomRight;
            // New code
            for (int i = 0; i < triangleVerticesFront.Length; i++ )
            {
                triangleVerticesFront[i].Normal = Vector3.Backward;
            }
            //
            ...
            VertexPositionNormalTextureColor[] triangleVerticesLeft = new VertexPositionNormalTextureColor[3];
            ...
            triangleVerticesLeft[0].Color = Color.White;
            ...
            triangleVerticesLeft[1].Color = Color.White;
            ...
            triangleVerticesLeft[2].Color = Color.White;
            triangleVerticesLeft[2].TextureCoordinate = bottomMiddle;
            // New code
            for (int i = 0; i < triangleVerticesLeft.Length; i++)
            {
                triangleVerticesLeft[i].Normal = Vector3.Left;
            }
            //
            ...
            VertexPositionNormalTextureColor[] triangleVerticesRight = new VertexPositionNormalTextureColor[3];
            ...
            triangleVerticesRight[0].Color = Color.White;
            ...
            triangleVerticesRight[1].Color = Color.White;
            ...
            triangleVerticesRight[2].Color = Color.White;
            triangleVerticesRight[2].TextureCoordinate = bottomMiddle;
            // New code
            for (int i = 0; i < triangleVerticesRight.Length; i++)
            {
                triangleVerticesRight[i].Normal = Vector3.Right;
            }
            //
            ...
            VertexPositionNormalTextureColor[] triangleVerticesBack = new VertexPositionNormalTextureColor[3];
            ...
            triangleVerticesBack[0].Color = Color.White;
            ...
            triangleVerticesBack[1].Color = Color.White;
            ...
            triangleVerticesBack[2].Color = Color.White;
            triangleVerticesBack[2].TextureCoordinate = bottomRight;
            // New code
            for (int i = 0; i < triangleVerticesBack.Length; i++)
            {
                triangleVerticesBack[i].Normal = Vector3.Forward;
            }
            //
