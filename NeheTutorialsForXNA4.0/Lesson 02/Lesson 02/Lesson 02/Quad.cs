...
namespace Lesson_02
{
    public class Quad
    {
        ...
        private VertexPosition[] m_Vertices;
        #endregion
        #region Constructors
        public Quad()
        {
        ...
        public Quad(float width, float height, ref Vector3 position)
        {
            Width = width;
            Height = height;
            Position = position;
        ...
        {
            m_Vertices = new VertexPosition[4];
            //bottom left corner
        ...
        public void Draw()
        {
            Graphics.GraphicsDevice.DrawUserPrimitives<VertexPosition>(PrimitiveType.TriangleStrip,
                m_Vertices, 0, 2);
        }
        #endregion
    }
